					...
					<logic:notEmpty name="<%=Constants.FULFILLED_OBSERVATORIES%>">
						<table>
							...
							<tr>
								...
								<th>
									<bean:message key="resultado.observatorio.rastreo.realizado.acciones" />
								</th>
							</tr>
									...
									<td>
										<ul class="lista_linea">
											...
											<logic:notEqual name="fulfilledObservatory" property="observatorio.estado" value="1">
												...
												<li>
													<html:link forward="<%=Constants.OBSERVATORY_GRAPHIC%>" name="params">
														<img src="../images/list.gif" alt="<bean:message key="indice.observatorio.resultados.alt"/>" />
													</html:link>
												</li>
												...
												<li>
													<html:link forward="anonymousExportOpenOfficeAction" name="params">
														<img src="../images/openoffice.png" alt="<bean:message key="indice.rastreo.exportar.openOffice" />" />
													</html:link>
												</li>
												<%-- </logic:equal> --%>
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeLenox%>">
													<li>
														<html:link forward="<%=Constants.OBSERVATORY_GRAPHIC%>" name="params">
															<img src="../images/transgender.png" alt="<bean:message key="indice.rastreo.ver.informe.rastreo" />" />
														</html:link>
													</li>
												</logic:equal>
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeMultilanguage%>">
													<li>
														<html:link forward="<%=Constants.OBSERVATORY_GRAPHIC%>" name="params">
															<img src="../images/multilanguage.png" alt="<bean:message key="indice.rastreo.ver.informe.rastreo" />" />
														</html:link>
													</li>
												</logic:equal>
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeIntav%>">
													<li>
														<html:link forward="uploadConclusion" name="params2">
															<img src="../images/ico_subir.png" alt="<bean:message key="indice.observatorio.conclusiones.alt" />" />
														</html:link>
													</li>
												</logic:equal>
												<li>
													<html:link forward="deleteFulfilledObservatory" name="params2">
														<img src="../images/bt_eliminar.gif" alt="<bean:message key="indice.observatorio.eliminar.alt" />" />
													</html:link>
												</li>
											</logic:notEqual>
											<logic:equal name="fulfilledObservatory" property="observatorio.estado" value="1">
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeIntav%>">
													...
													<li>
														<img src="../images/icono_pdf_disable.gif" alt="<bean:message key="indice.rastreo.exportar.pdf" />" />
													</li>
													<li>
														<img src="../images/icono_regenerar_pdf_disable.gif"
															alt="<bean:message key="indice.rastreo.exportar.pdf.regenerate" />" />
													</li>
													<li>
														<img src="../images/export_html_disable.png" alt="<bean:message key="indice.rastreo.exportar.html" />" />
													</li>
													<li>
														<img src="../images/openoffice_disable.png"
															alt="<bean:message key="indice.rastreo.exportar.openOffice" />" />
													</li>
												</logic:equal>
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeLenox%>">
													<li>
														<html:link forward="<%=Constants.OBSERVATORY_GRAPHIC%>" name="params">
															<img src="../images/transgender_disable.png"
																alt="<bean:message key="indice.rastreo.ver.informe.rastreo" />" />
														</html:link>
													</li>
												</logic:equal>
												<logic:equal name="fulfilledObservatory" property="cartucho.id" value="<%=idCartridgeMultilanguage%>">
													<li>
														<html:link forward="<%=Constants.OBSERVATORY_GRAPHIC%>" name="params">
															<img src="../images/multilanguage_disable.png"
																alt="<bean:message key="indice.rastreo.ver.informe.rastreo" />" />
														</html:link>
													</li>
												</logic:equal>
