...
<bean:define id="confidenceHigh">
	<inteco:properties key="confidence.level.high" file="<%=Constants.INTAV_PROPERTIES%>" />
</bean:define>
<bean:define id="confidenceMedium">
	<inteco:properties key="confidence.level.medium" file="<%=Constants.INTAV_PROPERTIES%>" />
</bean:define>
<bean:define id="confidenceCanNotTell">
	<inteco:properties key="confidence.level.cannottell" file="<%=Constants.INTAV_PROPERTIES%>" />
</bean:define>
...
<div id="migas">
	...
	<p class="oculto">
		<bean:message key="ubicacion.migas" />
	</p>
	<p>
		...
		<logic:present parameter="isCliente">
			...
			<html:link forward="loadClientCrawlings">
				<bean:message key="migas.rastreos.cliente" />
			</html:link>
 		/ <html:link forward="loadClientFulfilledCrawlings" name="paramsCFC">
				<bean:message key="migas.rastreos.realizados" />
			</html:link>
 		/ <html:link forward="showTracking" name="paramsCFC">
				<bean:message key="migas.rastreos.realizados.url.analizadas" />
			</html:link>
		/ <html:link forward="showAnalysisFromCrawlerRecover" name="paramsVolver">
				<bean:message key="migas.rastreos.realizados.resultados" />
			</html:link>
		</logic:present>
		<logic:notPresent parameter="isCliente">
			<html:link forward="crawlingsMenu">
				<bean:message key="migas.rastreo" />
			</html:link>
	 	/ <html:link forward="verRastreosRealizados" name="paramsVolver">
				<bean:message key="migas.rastreos.realizados" />
			</html:link>
	 	/ <html:link forward="showTracking" name="paramsVolver">
				<bean:message key="migas.rastreos.realizados.url.analizadas" />
			</html:link>
		/ <html:link forward="showAnalysisFromCrawlerRecover" name="paramsVolver">
				<bean:message key="migas.rastreos.realizados.resultados" />
		...
		/
		<bean:message key="migas.rastreos.realizados.detalle" />
	</p>
</div>
...
<div id="main">
	...
	<logic:notEmpty name="problem" property="rationale">
		...
		<p class="toggler">
			<bean:message key="analyse.explanation" />
		</p>
		<div class="rationale">
			<bean:message key="<%=keyRationale%>" />
		</div>
	</logic:notEmpty>

	<logic:notEmpty name="problem" property="specificProblems">

		<bean:define id="pagination">
			<inteco:properties key="pagination.check.results" file="intav.properties" />
		</bean:define>
		...
		<ul class="resultados">
			java.lang.Object specificProblem = (java.lang.Object) pageContext.getAttribute("specificProblem");
				<li><logic:notEmpty name="specificProblem" property="code">
						<p>
							<bean:message key="problem.line" />
							<bean:write name="specificProblem" property="line" />
							;
							<bean:message key="problem.column" />
							<bean:write name="specificProblem" property="column" />
						</p>
						<p>
							<bean:message key="problem.codice" />
						</p>
						<div class="codigo">
							<logic:notEmpty name="specificProblem" property="message">
								<p>
									<strong><bean:write name="specificProblem" property="message" /></strong>
								</p>
							</logic:notEmpty>
					...
					</logic:notEmpty> <logic:notEmpty name="specificProblem" property="note">
						<div class="nota">
	...
	<logic:notPresent parameter="isCliente">
		<p id="pCenter">
			<html:link styleClass="btn btn-default btn-lg" forward="showAnalysisFromCrawlerRecover" name="paramsVolver">
