    ...
    <div id="main">
        ...
        <div id="container_der">
            ...
            <div id="cajaformularios">
                ...
                <h2><bean:message key="observatory.stop.title" /></h2>

                <div class="detail">
                    <p><strong class="labelVisu"><bean:message key="observatory.stop.question" /></strong></p>
                    <p><strong class="labelVisu"><bean:message key="observatory.stop.info" /></strong></p>
                    <div class="formItem">
                    ...
                    <div class="formButton">
                        ...
                        <c:set target="${paramsSI}" property="action" value="stop" />
                        ...
                        <html:link styleClass="btn btn-primary btn-lg" forward="stopObservatorio" name="paramsSI"><bean:message key="boton.aceptar"/></html:link>
